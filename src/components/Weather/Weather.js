...
const Weather = props => (
            ...
            <div className={Styles.fontIcon}><i className={`owf owf-${props.id}`}></i></div>
                ...
                <div className={Styles.forecasts}>
                    ...
                    <div className={Styles.forecast}>{props.forecast1 && <div className={Styles.nextTemp}><p>{props.tomorrow.toLocaleString('en-US', options)}</p><p>{props.forecast1} °C</p></div>}</div>

                    <div className={Styles.forecast}>{props.forecast2 && <div className={Styles.nextTemp}><p>{props.afterTomorrow.toLocaleString('en-US', options)}</p><p>{props.forecast2} °C</p></div>}</div>

                    <div className={Styles.forecast}>{props.forecast3 && <div className={Styles.nextTemp}><p>{props.afterAfterTomorrow.toLocaleString('en-US', options)}</p><p>{props.forecast3} °C</p></div>}</div>
